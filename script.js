...
// Mapping to HTML containers
const containers = {
  "Cardiac Surgeon": document.getElementById("Cardiac Surgeon"),
  "Cosmetics": document.getElementById("Cosmetics"),
  "Gynaecologist": document.getElementById("Gynaecologist"),
  "Hematologist": document.getElementById("Hematologist"),
  "IVF Specialist": document.getElementById("IVF Specialist"),
  "Neurosurgeon": document.getElementById("Neurosurgeon"),
  "Oncologist": document.getElementById("Oncologist"),
  "Orthopaedic": document.getElementById("Orthopaedic"),
  "Dermatologist": document.getElementById("Dermatologist"),
  "Spine Surgeon": document.getElementById("Spine Surgeon"),
  "Transplant Specialist": document.getElementById("Transplant Specialist"),
  "Vascular Surgeon": document.getElementById("Vascular Surgeon"),
  "Urologist": document.getElementById("Urologist"),
  "Internal Medicine": document.getElementById("Internal Medicine"),
  "Rheumatologist": document.getElementById("Rheumatologist"),
  "Pulmonologist": document.getElementById("Pulmonologist"),
  "Endocrinologist": document.getElementById("Endocrinologist"),
  "Dentist": document.getElementById("Dentist"),
  "ENT Surgeon": document.getElementById("ENT Surgeon"),
  "Gastroenterologist": document.getElementById("Gastroenterologist"),
  "Nephrology": document.getElementById("Nephrology"),
  "Hepatology": document.getElementById("Hepatology"),
  "Opthalmology": document.getElementById("Opthalmology"),
  "Pediatric cardiology": document.getElementById("Pediatric cardiology"),
};
...
// Generate doctors dynamically
for (const [specialty, docs] of Object.entries(doctorsBySpecialty)) {
  const container = containers[specialty];
  if (!container) continue;

  docs.forEach((doc) => {
    const frame = document.createElement("div");
    frame.className = "col-4 col-md-2 text-center";
    ...
    img.addEventListener("mouseenter", () => {
      ...
      modalLocation.textContent = doc.location;
      modalHospital.textContent = doc.hospital;
      modalPosition.textContent = doc.position;
      modalExperience.textContent = doc.experience;
